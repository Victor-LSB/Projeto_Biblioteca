...
<body>
    <form action="" method="post">
        <input type="text" name="titulo" value="<?php echo htmlspecialchars($livro['titulo']); ?>" required><br>
        <input name="autor" placeholder="Autor" value="<?php echo htmlspecialchars($livro['autor']); ?>" required><br>
        <input type="text" name="genero" placeholder="Genero" value="<?php echo htmlspecialchars($livro['genero']); ?>" required><br>
        <textarea name="resenha" placeholder="Resenha" required ><?php echo htmlspecialchars($livro['resenha']); ?></textarea><br>
        <input type="text" name="capa" placeholder="Capa" value="<?php echo htmlspecialchars($livro['capa']); ?>" required><br>
